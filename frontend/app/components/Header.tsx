...
import avatar from "../../public/assets/default-avatar.png";
...
const Header: FC<Props> = ({ activeItem, route, setRoute, open, setOpen }) => {
              ...
              {user ? (
                <Link href={"/profile"}>
                  <Image
                    ...
                    style={{
                      border: activeItem === 4 ? "2px solid #37a39a" : "none",
                    }}
                  />
                </Link>
              ) : (
